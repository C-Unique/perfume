                                    ...
                                    <div class="checkout-product-body-item">
                                        <div class="checkout-product-body-item-content">
                                            ...
                                            <a href="index.jsp" target="_blank" class="checkout-product-body-item-img">
                                                <img src="img/${good.key.photo}" class="" alt="" title=""></a>
                                            <div class="checkout-product-body-item-info">
                                                <h6 class="checkout-product-body-item-productNameCN">${good.key.engname}</h6>
                                                <h6 class="checkout-product-body-item-productNameCN">${good.key.name}</h6>
                                            </div>
                                            <div class="checkout-product-body-item-unit">
                                                <div class="checkout-product-body-item-unit-price">
                                                    <span class="checkout-product-body-item-unit-sapPrice">${good.key.price}</span>
                                            ...
                                            <div class="checkout-product-body-item-amount">
                                                <div class="checkout-product-body-item-amount-warp">
                                                    <div class="mlnoe">
                                                    <span
                                                            class="checkout-product-body-item-amount-module-span">仅剩${good.key.stock}件</span>
                                                    </div>
                                                    <div class="checkout-product-body-item-amount-module">
                                                        <i class="checkout-product-body-item-amount-btn minus" onclick="redeuceNumberToCart(${good.key.id},1)">-</i>
                                                        <span class="checkout-product-body-item-amount-num">${good.value}</span>
                                                        <i class="checkout-product-body-item-amount-btn" onclick="addItemToCart(${good.key.id},1,${good.key.stock})">+</i>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="checkout-product-body-item-subtotal">
                                                <div class="checkout-product-body-item-unit-price">
                                                    <span class="checkout-product-body-item-unit-sapPrice">${good.key.price*good.value}</span>
                                                </div>
                                            </div>
                                            <div class="checkout-product-body-item-handle">
                                                <div class="checkout-product-body-item-handle-module">
                                                    <i class="checkout-product-body-item-handle-delete" onclick="del(${good.key.id})"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="fnb_section-content">
                            <div class="fnb_bill-thl row">
                                ...
                                <div
                                    ...
                                    ¥${sessionScope.cart.totalPrice}</div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="fnb_bill_fee fnb_col-wd4 fnb_text-4 pull-right fnb_font-2 fnb_text-right"
                                     id="taxes">¥${sessionScope.cart.totalPrice}</div>
                            </div>
