        ...
        <div class="container fnb_products-container fnb_plp-page load">
            ...
            <div class="row">
                <div class="fnb_pdp-image fnb_col-wd5 fnb_thumb-1">
                    <img class="fnb_img-responsive" src="img/${item.photo}" alt="">
                </div>
                <div class="fnb_col-wd6 information">
                    <div class="fnb_pdp-information">
                        <h1 class="fnb_pdp-title fnb_text-18">${item.name}</h1>
                        <p class="fnb_pdp-subtitle fnb_block-blc fnb_text-6">${item.engname}</p>
                    </div>
                    <div class="detailfnb_desc">${item.desc}</div>
                    ...
                    <div class="item fnb_col-wd12">
                        ...
                        <div class="button addToBagButton no-gutter-right">
                            <div class="has_btn" onclick="addItemToCart(${item.id},$('.text20').val())">
                                <button type="button"
